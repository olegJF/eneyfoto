...
fullSize:!1,minPadding:15},n={next:"Следующий",prev:"Предидущий",zoomIn:"Увеличить",zoomOut:"Уменьшить",fullSize:"Полный размер",fitScreen:"Под размер окна",close:"Закрыть",image:"Изображение",of:"из"},T,r,J=g(k,{id:"LG_titleBar"}),j=g("img",{id:"LG_pic"}),E=g(k,{id:"LG_prevLink",title:n.prev}),D=g(k,{id:"LG_nextLink",title:n.next}),v=g(k,{id:"LG_zoomNormal",title:n.fullSize}),Q=g(k,{id:"LG_zoomIn",title:n.zoomIn}),R=g(k,{id:"LG_zoomOut",title:n.zoomOut}),I=g(k,{id:"LG_imgIndex"},n.image+" 20 "+n.of+" 20 "),t=g("img"),z,C,
